...
async function post(ctx, next) {
  ...
  content_post = content_post.replace(/\$id/, ctx.query.id)
  content_post = content_post.replace(/\$usr_id/, ctx.query.usr_id)
  content_post = content_post.replace(/\$usr_name/, ctx.query.usr_name)
  content_post = content_post.replace(/\$usr_adress/, ctx.query.usr_adress)
  content_post = content_post.replace(/\$first_choice/, ctx.query.first_choice)
  console.log(content_post)
